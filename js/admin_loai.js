...
export const them_loai = async () => {
    let ten_loai = document.querySelector("#ten_loai").value;
    let nguon_goc = document.querySelector("#nguon_goc").value;
    let mo_ta = document.querySelector("#mo_ta").value;
    let xuat_xu = document.querySelector("#xuat_xu").value;
...
const motloai = (loai) => `<div class="loai">
        <span>${loai.id}</span>
...
export const xoa_loai = async (btn) => {
    let id = btn.getAttribute("idloai");
